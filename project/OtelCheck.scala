...
/**
 * otel4s-oteljava is compiled against one specific opentelemetry-java release. Our explicit
 * `io.opentelemetry` dependencies have to stay on that same version, or a Scala Steward bump
 * silently puts a newer SDK under otel4s. This reads the version otel4s actually declares out of
 * the pom.
 */
object OtelCheck {
