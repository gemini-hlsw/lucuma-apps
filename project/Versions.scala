object Versions {
  ...
  val giapiScala             = "0.3.1"
  val grackle                = "0.26.0"
  val graphQLRoutes          = "0.13.3"
  val http4s                 = "0.23.34"
  ...
  val log4s                  = "1.10.0"
  val logback                = "1.5.32"
  val lucumaCore             = "0.198-6fbf7fd-20260513T152550Z-SNAPSHOT"
  val lucumaPrimeStyles      = "0.5.0"
  val lucumaReact            = "0.100.0"
  val lucumaRefined          = "0.1.4"
  val lucumaServers          = "0.70.1"
  val monocle                = "3.3.0"
  val mouse                  = "1.4.0"
  val mUnit                  = "1.3.0"
