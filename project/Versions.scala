object Versions {
  ...
  val coulomb                = "0.9.1"
  val clue                   = "0.55-ffafbb1-20260623T041128Z-SNAPSHOT"
  val crystal                = "0.51.3"
  ...
  val log4s                  = "1.10.0"
  val logback                = "1.5.35"
  val lucumaCore             = "0.213.0"
  val lucumaPrimeStyles      = "0.5.0"
  val lucumaReact            = "0.102.0"
  val lucumaRefined          = "0.1.4"
  val lucumaServers          = "0.82.0"
  val monocle                = "3.3.0"
  val mouse                  = "1.4.0"
  val mUnit                  = "1.3.3"
