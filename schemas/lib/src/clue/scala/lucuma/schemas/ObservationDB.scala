...
trait ObservationDB {
  ...
  object Enums {
    ...
    type ConditionsExpectationType           = enums.ConditionsExpectationType
    type ConditionsMeasurementSource         = enums.ConditionsMeasurementSource
    ...
    type GmosIfuAcquisitionRoi               = enums.GmosIfuAcquisitionRoi
    type GmosLongSlitAcquisitionRoi          = enums.GmosLongSlitAcquisitionRoi
    type GmosNorthIfuFpu                     = enums.GmosNorthIfuFpu
    type GmosSouthIfuFpu                     = enums.GmosSouthIfuFpu
    ...
    type ProposalSummaryGenerationState      = enums.ProposalSummaryGenerationState
