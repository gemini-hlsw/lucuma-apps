...
trait CatalogPicklers extends ItcPicklers:
  ...
  given picklerGmosIfu: Pickler[AgsParams.GmosIfu]         = generatePickler
  ...
  given Pickler[AgsParams.Flamingos2Mos] = generatePickler
