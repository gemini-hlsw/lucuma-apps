...
trait DisplayImplicits:
  ...
  given Display[ConfigurationKind] = Display.byShortName:
    case ConfigurationKind.Spectroscopy => "Spectroscopy"
    case ConfigurationKind.Imaging      => "Imaging"
    case ConfigurationKind.Visitor      => "Visitor"
