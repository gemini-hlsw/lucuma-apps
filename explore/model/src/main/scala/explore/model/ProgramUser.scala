...
object ProgramUser:
  ...
  val classicalObserver: Lens[ProgramUser, Boolean] =
    Focus[ProgramUser](_.classicalObserver)
  ...
  given Decoder[ProgramUser] = c =>
    for {
      ...
      co   <- c.downField("classicalObserver").as[Boolean]
