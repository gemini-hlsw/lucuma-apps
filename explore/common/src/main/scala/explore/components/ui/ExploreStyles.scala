...
object ExploreStyles:
  ...
  val TileTitleConfigSelectorPanel: Css = Css("explore-tile-title-config-selector-panel")
  ...
  val TileBodyHidden: Css               = Css("explore-tile-body-hidden")
  ...
  val ResizableTree: Css        = Css("resizable-tree")
  ...
  val ProgramsPopupTitle = Css("programs-popup-title")
  ...
  val LoadProgressPending: Css = Css("load-progress-pending")
  ...
  val AladinGuideProbePanel: Css  = Css("aladin-guide-probe-panel")
  ...
  val AeonRequiredInstruments: Css   = Css("explore-aeon-required-instruments")
  ...
  val DismissedWarningIcon: Css = Css("explore-dismissed-warning-icon")
  ...
  val ConfigurationSteps: Css              = Css("explore-configuration-steps")
  val ConfigurationStepMarker: Css         = Css("explore-configuration-step-marker")
  val ConfigurationStepDone: Css           = Css("explore-configuration-step-done")
  val ConfigurationStepCurrent: Css        = Css("explore-configuration-step-current")
  val ConfigurationStepBlocked: Css        = Css("explore-configuration-step-blocked")
  val ConfigurationStepBlockerNote: Css    = Css("explore-configuration-step-blocker-note")
  ...
  val MosMaskSlit                   = Css("mos-mask-slit")
  val MosMaskAcquisitionBox         = Css("mos-mask-acq-box")
