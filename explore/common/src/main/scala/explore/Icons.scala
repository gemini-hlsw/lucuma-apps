...
object Icons {
  ...
  @js.native
  @JSImport("@fortawesome/pro-light-svg-icons", "faRocketLaunch")
  val faRocketLaunchLight: FAIcon = js.native
  ...
  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faMessageLines")
  val faMessageLines: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faListRadio")
  val faListRadioSolid: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faArrowUpRightFromSquare")
  val faArrowUpRightFromSquareSolid: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faBarcodeRead")
  val faBarCodeReadSolid: FAIcon = js.native

  @js.native
  @JSImport("@fortawesome/pro-solid-svg-icons", "faPencil")
  val faPencilSolid: FAIcon = js.native
  ...
  val MessageLines                = FontAwesomeIcon(faMessageLines)
  val ListRadioSolid              = FontAwesomeIcon(faListRadioSolid)
  val ArrowUpRightFromSquareSolid = FontAwesomeIcon(faArrowUpRightFromSquareSolid)
  val BarCodeReadSolid            = FontAwesomeIcon(faBarCodeReadSolid)
  val PencilSolid                 = FontAwesomeIcon(faPencilSolid)
